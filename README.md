...
Fan project — no affiliation with  the original creators.
...
bashgit clone https://github.com/PanagiotisChiras/unstable-unicorns-engine.git
cd unstable-unicorns-engine
cmake -B build
cmake --build build
./build/UnstableUnicorns
